...
class CubeCore {
  ...
  moveF() {
    ...
    this.stickerRotations.U[6] = this.stickerRotations.L[8]; this.stickerRotations.U[7] = this.stickerRotations.L[5]; this.stickerRotations.U[8] = this.stickerRotations.L[2];
    ...
    this.stickerRotations.L[8] = this.stickerRotations.D[2]; this.stickerRotations.L[5] = this.stickerRotations.D[1]; this.stickerRotations.L[2] = this.stickerRotations.D[0];
    ...
    this.stickerRotations.D[2] = this.stickerRotations.R[0]; this.stickerRotations.D[1] = this.stickerRotations.R[3]; this.stickerRotations.D[0] = this.stickerRotations.R[6];
    ...
    this.stickerRotations.R[0] = tR[0]; this.stickerRotations.R[3] = tR[1]; this.stickerRotations.R[6] = tR[2];
  ...
  moveB() {
    ...
    this.stickerRotations.U[0] = this.stickerRotations.R[2]; this.stickerRotations.U[1] = this.stickerRotations.R[5]; this.stickerRotations.U[2] = this.stickerRotations.R[8];
    ...
    this.stickerRotations.R[2] = this.stickerRotations.D[8]; this.stickerRotations.R[5] = this.stickerRotations.D[7]; this.stickerRotations.R[8] = this.stickerRotations.D[6];
    ...
    this.stickerRotations.D[8] = this.stickerRotations.L[6]; this.stickerRotations.D[7] = this.stickerRotations.L[3]; this.stickerRotations.D[6] = this.stickerRotations.L[0];
    ...
    this.stickerRotations.L[6] = tR[0]; this.stickerRotations.L[3] = tR[1]; this.stickerRotations.L[0] = tR[2];
